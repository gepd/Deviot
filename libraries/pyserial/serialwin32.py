...
class Serial(SerialBase):
    ...
    def open(self):
        ...
        try:
            ...
            win32.GetCommTimeouts(
                self._port_handle, ctypes.byref(self._orgTimeouts))
    ...
    def _reconfigure_port(self):
        ...
        if self._timeout is None:
            ...
            timeouts.ReadTotalTimeoutConstant = max(
                int(self._timeout * 1000), 1)
        ...
        if self._parity == PARITY_NONE:
            ...
            raise ValueError(
                "Unsupported parity mode: {!r}".format(self._parity))
    ...
    def write(self, data):
        ...
        if data:
            ...
            n = win32.DWORD()
            success = win32.WriteFile(self._port_handle, data, len(
                data), ctypes.byref(n), self._overlapped_write)
            ...
            if self._write_timeout != 0:
                ...
                if errorcode in (win32.ERROR_INVALID_USER_BUFFER, win32.ERROR_NOT_ENOUGH_MEMORY,
                    ...
                    # no info on true length provided by OS function in async
                    # mode
                    return len(data)
                else:
                    raise SerialException(
